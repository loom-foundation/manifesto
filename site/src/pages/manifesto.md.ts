 ...
 * and all). The file is read in place from the manifesto repo root — the
 * same canonical source the content collection renders — so the two can
 * never drift.
 */
const source = readFileSync(resolve(process.cwd(), '../manifesto.md'), 'utf-8');
