...
export default defineConfig({
  ...
  vite: {
    server: {
      // Allow Vite to serve the site's own tree and the manifesto
      // content (`..` covers manifesto.md and signatories/), plus the
      // org brand artefacts in ../../org/brand (favicon, wordmarks,
      // logo). The site does not depend on the design-system package,
      // so ../../packages is deliberately left out of the allowlist.
      fs: { allow: ['..', '../../org'] },
    },
  },
  markdown: {
