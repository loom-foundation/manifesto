...
Warp and weft make the fabric:

- **Warp (Requirement):** Intent becomes requirement. The *what*, drawn taut, the frame every thread is woven on.

- **Weft (Specification):** Requirement becomes specification. The *how*, carried across the warp, pick by pick.

The reed beats every pick true before the next is thrown.

*The product is the fabric, and the fabric only holds when both move.*
